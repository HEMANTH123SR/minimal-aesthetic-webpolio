...
export default function Home() {
  ...
  return (
    <main className="w-full h-full">
      <div
        className="hidden md:block fixed h-auto w-auto py-5 p-2 left-0 top-1/2 bg-[#333333] text-white font-semibold rounded-l-xl cursor-pointer "
        style={{
      ...
      >
        ...
        <div className="flex flex-col space-y-3">
          ...
          <p className="w-full sm:w-2/3 font-semibold text-sm">
            {user.summary}
          </p>
        </div>
        ...
        <div
          className="flex flex-col  border-t  w-full sm:w-2/3  md:pb-36 pt-6 justify-start items-start space-y-3"
        ...
        <div className="md:hidden w-full h-36 flex justify-center items-end">

          <div className="h-auto w-2/3 flex justify-center items-center py-2.5 bg-[#333333] text-white font-semibold text-xl underline rounded-t-2xl  cursor-pointer">
            webpolio
          </div>
